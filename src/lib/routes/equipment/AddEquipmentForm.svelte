...
<form class="grid grid-cols-1 gap-4 mt-4" on:submit|preventDefault={onSubmit}>
  ...
  <div class="flex flex-col">
    <label for="km" class="text-sm text-gray-600">Kilometros</label>
    <input id="km" class="border border-gray-300 rounded-md px-3 py-2 mt-1 focus:outline-none focus:border-indigo-500" type="number" placeholder="Kilometros del Equipo" bind:value={km} />
  </div>
